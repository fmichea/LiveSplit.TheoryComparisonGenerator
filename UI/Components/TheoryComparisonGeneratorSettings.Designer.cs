...
namespace LiveSplit.UI.Components
{
	partial class TheoryComparisonGeneratorSettings
	{
		...
		private void InitializeComponent()
		{
            ...
            this.labelErrorFileOpen.Text = "ERROR: Another LiveSplit instance is currently editing this layout. Please close " +
    "both before modifying Theory Times in LiveSplit.";
            this.labelErrorFileOpen.Visible = false;
            // 
